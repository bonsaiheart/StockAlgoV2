    ...
    async with db_pool.acquire() as conn:
        try:
            ...
            SELECT o.expiration_date, o.option_type, o.strike, 
                   oq.volume, oq.open_interest, oq.greeks,
                   oq.fetch_timestamp
            ...
            # Convert option_data to a DataFrame and continue with your calculations
            optionchain_df = pd.DataFrame(option_data, columns=['expiration_date', 'option_type', 'strike',
            ...
            if not optionchain_df.empty:
                ...
                for exp_date, group in groups:
                    ...
                    data_to_insert["fetch_timestamp"] = current_time
                    await insert_processed_data(conn=conn,data=data_to_insert)

                    #  (No need to save to CSV anymore)
                    return optionchain_df,  processed_data_df, data_to_insert # Return statements
...
async def insert_processed_data(conn, data):
    ...
    query = """
    INSERT INTO csvimport.processed_option_data (
        symbol_name, fetch_timestamp, exp_date, current_stock_price, current_sp_change_lac,
        maximumpain, bonsai_ratio, bonsai_ratio_2, b1_dividedby_b2, b2_dividedby_b1,
        pcr_vol, pcr_oi, pcrv_up1, pcrv_up2, pcrv_up3, pcrv_up4,
        pcrv_down1, pcrv_down2, pcrv_down3, pcrv_down4,
        pcroi_up1, pcroi_up2, pcroi_up3, pcroi_up4,
        pcroi_down1, pcroi_down2, pcroi_down3, pcroi_down4,
        itm_pcr_vol, itm_pcr_oi,
        itm_pcrv_up1, itm_pcrv_up2, itm_pcrv_up3, itm_pcrv_up4,
        itm_pcrv_down1, itm_pcrv_down2, itm_pcrv_down3, itm_pcrv_down4,
        itm_pcroi_up1, itm_pcroi_up2, itm_pcroi_up3, itm_pcroi_up4,
        itm_pcroi_down1, itm_pcroi_down2, itm_pcroi_down3, itm_pcroi_down4,
        itm_oi, total_oi, itm_contracts_percent,
        net_iv, net_itm_iv, net_iv_mp, niv_current_strike,
        niv_1higher_strike, niv_1lower_strike, niv_2higher_strike, niv_2lower_strike,
        niv_3higher_strike, niv_3lower_strike, niv_4higher_strike, niv_4lower_strike,
        niv_highers_minus_lowers1thru2, niv_highers_minus_lowers1thru4,
        niv_1thru2_avg_percent_from_mean, niv_1thru4_avg_percent_from_mean,
        niv_dividedby_oi, itm_avg_niv_dividedby_itm_oi, closest_strike_to_cp
    ) VALUES (
    ...
    try:
        await conn.execute(query,
                           data['symbol_name'], data['fetch_timestamp'], data['exp_date'],
                           data['current_stock_price'], data['current_sp_change_lac'],
                           data['maximumpain'], data['bonsai_ratio'], data['bonsai_ratio_2'],
                           data['b1_dividedby_b2'], data['b2_dividedby_b1'],
                           data['pcr_vol'], data['pcr_oi'],
                           data['pcrv_up1'], data['pcrv_up2'], data['pcrv_up3'], data['pcrv_up4'],
                           data['pcrv_down1'], data['pcrv_down2'], data['pcrv_down3'], data['pcrv_down4'],
                           data['pcroi_up1'], data['pcroi_up2'], data['pcroi_up3'], data['pcroi_up4'],
                           data['pcroi_down1'], data['pcroi_down2'], data['pcroi_down3'], data['pcroi_down4'],
                           data['itm_pcr_vol'], data['itm_pcr_oi'],
                           data['itm_pcrv_up1'], data['itm_pcrv_up2'], data['itm_pcrv_up3'],
                           data['itm_pcrv_up4'],
                           data['itm_pcrv_down1'], data['itm_pcrv_down2'], data['itm_pcrv_down3'],
                           data['itm_pcrv_down4'],
                           data['itm_pcroi_up1'], data['itm_pcroi_up2'], data['itm_pcroi_up3'],
                           data['itm_pcroi_up4'],
                           data['itm_pcroi_down1'], data['itm_pcroi_down2'], data['itm_pcroi_down3'],
                           data['itm_pcroi_down4'],
                           data['itm_oi'], data['total_oi'], data['itm_contracts_percent'],
                           data['net_iv'], data['net_itm_iv'], data['net_iv_mp'], data['niv_current_strike'],
                           data['niv_1higher_strike'], data['niv_1lower_strike'], data['niv_2higher_strike'],
                           data['niv_2lower_strike'],
                           data['niv_3higher_strike'], data['niv_3lower_strike'], data['niv_4higher_strike'],
                           data['niv_4lower_strike'],
                           data['niv_highers_minus_lowers1thru2'], data['niv_highers_minus_lowers1thru4'],
                           data['niv_1thru2_avg_percent_from_mean'], data['niv_1thru4_avg_percent_from_mean'],
                           data['niv_dividedby_oi'], data['itm_avg_niv_dividedby_itm_oi'],
                           data['closest_strike_to_cp']
                           )
    except Exception as e:

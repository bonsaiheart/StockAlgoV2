...
def train_model(param_dict, X, y, final_classifier=None):
    ...
    print(
        f"avg_accuracy: {best_accuracy},avg_f1: {best_f1}, avg_precision: {best_precision}, avg_recall: {best_recall},avg_auc: {avg_auc},  avg_logloss: {avg_logloss}) / {num_folds}, "
    )
    return {
...
while True:
    try:
        study = optuna.load_study(
            study_name="SPY_best_auc_a_GOSS_3hr35percent",

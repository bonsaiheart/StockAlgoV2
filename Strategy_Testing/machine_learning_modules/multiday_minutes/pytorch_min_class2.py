...
set_best_params_manually = {'learning_rate': 1.4273231212290852e-05, 'num_epochs': 339, 'batch_size': 826, 'optimizer': 'SGD', 'dropout_rate': 0.16381599264708432, 'num_hidden_units': 1098}
...
Chosen_Predictor = [
    ...
    "B1/B2",
     ...
     'ITM PCR-Vol'
    # ,"ITM PCRv Up3",'ITM PCRoi Up1','ITM PCRoi Down1', 'Net_IV', 'Net ITM IV',
#     "ITM PCRv Down3",
...
anticondition_threshold_cells_down = cells_forward_to_check * .5
...
######################################################################################################################################################
task = "binary"
precision_up = Precision(num_classes=2, average='weighted', task=task).to(device)( predicted_up_tensor,y_up_test_tensor)  # move metric to same device as tensors

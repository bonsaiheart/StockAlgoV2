...
mse_metric = torchmetrics.MeanSquaredError().to(device)  # Move the metric to the device
...
X_train, X_temp, y_train, y_temp = train_test_split(
    X, y_change, test_size=1 - trainsizepercent, random_state=42
)
...
# TODO
best_params = {
    "learning_rate": 3.0928729174797677e-05,
    "num_epochs": 971,
    "batch_size": 2021,
    "dropout_rate": 0.3875633252260715,
    "num_hidden_units": 321,
    "weight_decay": 0.06356107108275695,
    "l1_lambda": 0.001930392398006833,
    "lr_scheduler": "ExponentialLR",
    "optimizer": "AdamW",
    "num_layers": 5,
    "gamma": 0.34869273877896945,
}
...
(
    ...
    smallest_val_loss,
    r2_avg,
) = train_model(best_params, X_train_tensor, y_train_tensor, X_val_tensor, y_val_tensor)

...
study_name = ('_20min_20pt_down_FeatSet1')
n_trials = 10000
...
X_train, X_val, y_up_train, y_up_val = train_test_split(
    X_remaining, y_up_remaining, test_size=0.30, random_state=None, shuffle=False
)
...
def objective(trial):
    ...
    learning_rate = trial.suggest_float("learning_rate", .00005, 0.007, log=True)  # 0003034075497582067

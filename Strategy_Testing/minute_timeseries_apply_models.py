...
##TODO cant locate files... somethign to do with base_dir mabe
    ...
    Sell_A5 = tm.Sell_A5(dailyminutes_df[['Bonsai Ratio', 'B1/B2', 'PCRv Up4', 'ITM PCRv Up4', 'ITM PCRoi Up4',
                         'ITM PCRoi Down4']])

...
def get_buy_signal_BonsaiRatio_ITMPCRV_30min(new_data_df):
    ...
    model_filename = 'Trained_Models/BonsaiRatio_ITMPCRV_30min/trained_model_target_up.joblib'
    loaded_model = joblib.load(model_filename)
...
def get_sell_signal_BonsaiRatio_ITMPCRV_30min(new_data_df):
    model_filename = 'Trained_Models/BonsaiRatio_ITMPCRV_30min/trained_model_target_down.joblib'
    loaded_model = joblib.load(model_filename)
